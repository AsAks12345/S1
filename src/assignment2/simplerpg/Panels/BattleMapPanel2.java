 ...
 * @author yucha
 */
public class BattleMapPanel2 extends BattleMap {
     ...
     */
    public BattleMapPanel2(SimpleRPGStart root) {
        this.root = root;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(114, 136, 810, 530));

        jTextField1.setEditable(false);
        jTextField1.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 50)); // NOI18N
        jTextField1.setText("Magma");
        add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 30, -1, -1));
    ...
    private void attack(java.awt.event.MouseEvent evt) {
        ...
        if (isEliminated()) {
            ...
            BattleMapPanel3 bmp3 = (BattleMapPanel3) root.getBattleMapPanel3();
            bmp3.setHero(hero);
            root.setPanelsVisible(root.getBattleMapPanel3());
